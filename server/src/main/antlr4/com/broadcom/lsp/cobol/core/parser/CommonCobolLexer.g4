...
CHAR_N : SINGLEQUOTE N SINGLEQUOTE {sqlFlag}? ;
CHAR_A : SINGLEQUOTE A SINGLEQUOTE {sqlFlag}? ;
CHAR_R : SINGLEQUOTE R SINGLEQUOTE {sqlFlag}? ;
...
INTEGERLITERAL : (PLUSCHAR | MINUSCHAR)? DIGIT+ | LEVEL_NUMBER | LEVEL_NUMBER_66 | LEVEL_NUMBER_77 | LEVEL_NUMBER_88 | NUMBER_1 | NUMBER_2 | NUMBER_4 | NUMBER_5 | NUMBER_6 | NUMBER_10 | NUMBER_12 | NUMBER_14 | NUMBER_15 | NUMBER_16 | NUMBER_20 | NUMBER_30 NUMBER_31 | NUMBER_33 | NUMBER_34 | NUMBER_64 | NUMBER_100 | NUMBER_256 | NUMBER_1200 | NUMBER_1208 | INTEGER_MAX ;
