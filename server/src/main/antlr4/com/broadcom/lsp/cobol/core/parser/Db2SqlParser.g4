...
dbs_address_value: dbs_ip4 | dbs_hostname_identifier ;
...
dbs_program_name: NONNUMERICLITERAL | NUMERICLITERAL;
...
dbs_smallint: MINUSCHAR? SINGLEDIGITLITERAL SINGLEDIGITLITERAL?;// java ref - -1 to 99
