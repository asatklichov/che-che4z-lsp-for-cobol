...
ZERO_TO_NINE : DIGIT_GREATER_THAN_ZERO;
HOSTNAME_IDENTIFIER : TXTLITERAL | ([a-zA-Z0-9_@-] | SLASHCHAR | COLONCHAR | DOT)+;
...
DECIMAL_CONST_SPEC: DIGIT_GREATER_THAN_ZERO DIGIT DIGIT DIGIT DOT DIGIT;
//SINGLE_DIGIT : DIGIT;
